      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative max-w-xl mx-auto mb-8">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-full border border-gray-200 bg-white shadow-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 text-gray-700 text-sm"
          />
          {searchQuery && (
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive ? "bg-primary text-white border-primary shadow-md shadow-primary/20" : "bg-white text-gray-600 border-gray-200 hover:border-primary/40 hover:text-primary"
                )}
              >
